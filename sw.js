const CACHE='away-golf-v15-37';
const FILES=['./','./index.html','./styles.css?v=15.37','./supabase.js?v=15.37','./cloud.js?v=15.37','./data.js?v=15.37','./app.js?v=15.37','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
