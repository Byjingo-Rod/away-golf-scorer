const CACHE='away-golf-v15-38';
const FILES=['./','./index.html','./styles.css?v=15.38','./supabase.js?v=15.38','./cloud.js?v=15.38','./data.js?v=15.38','./app.js?v=15.38','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
