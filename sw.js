const CACHE='away-golf-v15-51';
const FILES=['./','./index.html','./styles.css?v=15.51','./supabase.js?v=15.51','./cloud.js?v=15.51','./data.js?v=15.51','./app.js?v=15.51','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./assets/away-golf-mascot.png','./away-golf-mascot-mini.png'];
