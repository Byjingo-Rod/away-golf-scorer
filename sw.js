const CACHE='away-golf-v15-14';
const FILES=['./','./index.html','./styles.css?v=15.14','./supabase.js?v=15.14','./cloud.js?v=15.14','./data.js?v=15.14','./app.js?v=15.14','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
