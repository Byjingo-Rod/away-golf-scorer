const CACHE='away-golf-v15-46';
const FILES=['./','./index.html','./styles.css?v=15.46','./supabase.js?v=15.46','./cloud.js?v=15.46','./data.js?v=15.46','./app.js?v=15.46','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./assets/away-golf-mascot.png','./away-golf-mascot-mini.png'];
