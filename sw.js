const CACHE='away-golf-v15-15';
const FILES=['./','./index.html','./styles.css?v=15.15','./supabase.js?v=15.15','./cloud.js?v=15.15','./data.js?v=15.15','./app.js?v=15.15','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
