const CACHE='away-golf-v15-12';
const FILES=['./','./index.html','./styles.css?v=15.12','./data.js?v=15.12','./app.js?v=15.12','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
