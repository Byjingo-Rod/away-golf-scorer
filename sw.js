const CACHE='away-golf-v15-13';
const FILES=['./','./index.html','./styles.css?v=15.13','./supabase.js?v=15.13','./cloud.js?v=15.13','./data.js?v=15.13','./app.js?v=15.13','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
