const CACHE='away-golf-v15-36';
const FILES=['./','./index.html','./styles.css?v=15.36','./supabase.js?v=15.36','./cloud.js?v=15.36','./data.js?v=15.36','./app.js?v=15.36','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
