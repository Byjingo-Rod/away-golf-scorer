const CACHE='away-golf-v15-34';
const FILES=['./','./index.html','./styles.css?v=15.34','./supabase.js?v=15.34','./cloud.js?v=15.34','./data.js?v=15.34','./app.js?v=15.34','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
