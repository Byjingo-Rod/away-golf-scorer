const CACHE='away-golf-v15-43';
const FILES=['./','./index.html','./styles.css?v=15.43','./supabase.js?v=15.43','./cloud.js?v=15.43','./data.js?v=15.43','./app.js?v=15.43','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
