const CACHE='away-golf-v15-35';
const FILES=['./','./index.html','./styles.css?v=15.35','./supabase.js?v=15.35','./cloud.js?v=15.35','./data.js?v=15.35','./app.js?v=15.35','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
