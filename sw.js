const CACHE='away-golf-v15-42';
const FILES=['./','./index.html','./styles.css?v=15.42','./supabase.js?v=15.42','./cloud.js?v=15.42','./data.js?v=15.42','./app.js?v=15.42','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
