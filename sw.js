const CACHE='away-golf-v15-44';
const FILES=['./','./index.html','./styles.css?v=15.44','./supabase.js?v=15.44','./cloud.js?v=15.44','./data.js?v=15.44','./app.js?v=15.44','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./assets/away-golf-mascot.png'];
