const CACHE='away-golf-v15-54';
const FILES=['./','./index.html','./styles.css?v=15.54','./supabase.js?v=15.54','./cloud.js?v=15.54','./data.js?v=15.54','./app.js?v=15.54','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./assets/away-golf-mascot.png','./away-golf-mascot-mini.png'];
