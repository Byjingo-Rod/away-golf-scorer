const CACHE='away-golf-v15-33';
const FILES=['./','./index.html','./styles.css?v=15.33','./supabase.js?v=15.33','./cloud.js?v=15.33','./data.js?v=15.33','./app.js?v=15.33','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
