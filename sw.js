const CACHE='away-golf-v15-10';
const FILES=['./','./index.html','./styles.css?v=15.10','./data.js?v=15.10','./app.js?v=15.10','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
