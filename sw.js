const CACHE='away-golf-v15-41';
const FILES=['./','./index.html','./styles.css?v=15.41','./supabase.js?v=15.41','./cloud.js?v=15.41','./data.js?v=15.41','./app.js?v=15.41','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
