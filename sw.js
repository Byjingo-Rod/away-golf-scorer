const CACHE='away-golf-v15-45';
const FILES=['./','./index.html','./styles.css?v=15.45','./supabase.js?v=15.45','./cloud.js?v=15.45','./data.js?v=15.45','./app.js?v=15.45','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./assets/away-golf-mascot.png'];
