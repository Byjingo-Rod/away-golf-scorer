const CACHE='away-golf-v15-52';
const FILES=['./','./index.html','./styles.css?v=15.52','./supabase.js?v=15.52','./cloud.js?v=15.52','./data.js?v=15.52','./app.js?v=15.52','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./assets/away-golf-mascot.png','./away-golf-mascot-mini.png'];
