const CACHE='away-golf-v15-53';
const FILES=['./','./index.html','./styles.css?v=15.53','./supabase.js?v=15.53','./cloud.js?v=15.53','./data.js?v=15.53','./app.js?v=15.53','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./assets/away-golf-mascot.png','./away-golf-mascot-mini.png'];
