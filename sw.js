const CACHE='away-golf-v15-18';
const FILES=['./','./index.html','./styles.css?v=15.18','./supabase.js?v=15.18','./cloud.js?v=15.18','./data.js?v=15.18','./app.js?v=15.18','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
