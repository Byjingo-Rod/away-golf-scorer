const CACHE='away-golf-v15-39';
const FILES=['./','./index.html','./styles.css?v=15.39','./supabase.js?v=15.39','./cloud.js?v=15.39','./data.js?v=15.39','./app.js?v=15.39','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
